...
def plot_rgb2semseg(rgb, semseg_gt, output_argmax, save_path=None):
    ...
    axes[1].imshow(semseg_to_rgb(semseg_gt[0].cpu()))
    axes[1].set_title('Semseg GT', fontsize=16)

    axes[2].imshow(semseg_to_rgb(output_argmax[0].cpu()))
